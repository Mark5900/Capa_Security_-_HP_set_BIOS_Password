...
#### FUNCTIONS ####
###################
function PreUnUninstall {
  $cs.Log_SectionHeader("PreUnUninstall",'o')
}

function Uninstall {
  $cs.Log_SectionHeader("Uninstall",'o')
}

function PostUninstall {
  $cs.Log_SectionHeader("PostUninstall",'o')
}
...
try {
  ...
  #Begin
  $cs.Job_Start("WS",$global:AppName,$global:AppRelease,$global:LogFile,"UNUninstall")
